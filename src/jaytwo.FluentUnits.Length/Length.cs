...
namespace jaytwo.FluentUnits
{
    ...
    public struct Length : IComparable<Length>, IEquatable<Length>
    {
        ...
        public static Length operator -(Length a, Length b) => new Length(a.Meters - b.Meters);
        public static Length operator *(Length a, decimal b) => new Length(a.Meters * b);
        public static Length operator *(Length a, double b) => new Length(a.Meters * Convert.ToDecimal(b));
        public static Length operator *(Length a, long b) => new Length(a.Meters * Convert.ToDecimal(b));
        public static Length operator /(Length a, decimal b) => new Length(a.Meters / b);
        public static Length operator /(Length a, double b) => new Length(a.Meters / Convert.ToDecimal(b));
        public static Length operator /(Length a, long b) => new Length(a.Meters / Convert.ToDecimal(b));
